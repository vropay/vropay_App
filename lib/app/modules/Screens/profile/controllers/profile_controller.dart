...
class ProfileController extends GetxController {
  ...
  Future<void> loadUserData() async {
    try {
      ...
      print('🚀 ProfileController - Loading user data from API...');
      ...
      if (userData != null) {
        ...
        // Update preferences from backend data
        ...
        // Set selected interests for topics dialog
        selectedInterests.value = selectedTopicsList.toList();

        print(
            '✅ ProfileController - User data loaded and UI updated successfully');
      } else {
        print('⚠️ ProfileController - No user data received from API');
      }

      // Load interests after user data
      await loadInterests();
    } catch (e) {
  ...
  Future<void> loadInterests() async {
    try {
      ...
      if (response['interests'] is List) {
        ...
        // Set currently selected interests from user's saved topics
        selectedInterests.value = selectedTopicsList.toList();
  ...
  Future<void> saveSelectedInterests() async {
    try {
      ...
      updateTopics(selectedInterests.toList());
    } catch (e) {
